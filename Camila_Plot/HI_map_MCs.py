...
giants = Table.read('/Users/mncavieres/Documents/2024-1/Delve/Camila_Plot/filtered_stars.fits')
...
plt.scatter(giants['RA2000'], giants['DEC2000'], transform=ax.get_transform('icrs'),
           s=5, marker='.', edgecolor='plum', facecolor='none', label=r'Giants (60 - 100 kpc)')
