...
candidates = Table.read('/Users/mncavieres/Documents/2024-1/Delve/Plots/stream_results/xshooter_candidates.csv')
...
cbr_t= plt.scatter(candidates['RA2000'], candidates['DEC2000'], transform=ax.get_transform('icrs'),
           s=50, marker='*', c = 'purple', label=r'XSHOOTER candidates', edgecolor='k')
...
plt.tight_layout()
plt.savefig('/Users/mncavieres/Documents/2024-1/Delve/Plots/stream_results/aitoff_stream.pdf', format='pdf')
plt.close()